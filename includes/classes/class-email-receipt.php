...
class Email_Receipt extends Email {
	...
	public function __construct() {
		add_action( 'pff_flutterwave_send_receipt', [ $this, 'send_receipt' ], 10, 7 );
	}
												...
												<tbody>
													<tr>
														<td class="column_cell font_default" align="center" valign="top" style="padding:16px;font-family:Helvetica,Arial,sans-serif;font-size:15px;text-align:center;vertical-align:top;color:#888">
															...
															<h5 style="font-family:Helvetica,Arial,sans-serif;margin-left:0;margin-right:0;margin-top:16px;margin-bottom:8px;padding:0;font-size:18px;line-height:26px;font-weight:bold;color:#472A7A">
														...
														<td class="column_cell font_default" align="center" valign="top" style="padding:16px;font-family:Helvetica,Arial,sans-serif;font-size:15px;text-align:left;vertical-align:top;color:#888;padding-top:0;padding-bottom:0">
																...
																<tbody>
																	...
																	<tr>
																		<td class="font_default" style="padding:3px 7px;font-family:Helvetica,Arial,sans-serif;font-size:10px;font-weight:bold;text-transform:uppercase;letter-spacing:2px;-webkit-border-radius:2px;border-radius:2px;white-space:nowrap;background-color:#F36F21;color:#fff">
																			<?php esc_html_e( 'Your Details', 'pff-flutterwave' ); ?>
																		</td>
																	</tr>
																</tbody>
															</table>
															<p style="font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:23px;margin-top:8px;margin-bottom:16px">
																...
																printf(
																	...
																	esc_html__( 'Amount : %1$s %2$s', 'pff-flutterwave' ),
																...
																printf(
																	...
																	esc_html__( 'Email : %1$s', 'pff-flutterwave' ),
																	esc_html( $this->email )
																);
																?><br>
																<?php
																...
																printf(
																	...
																	esc_html__( 'Transaction code: %s', 'pff-flutterwave' ),
																	esc_html( $this->code )
																);
																?><br>
															</p>
													...
													<tr>
														<td class="column_cell font_default" align="center" valign="top" style="padding:16px 16px 0;font-family:Helvetica,Arial,sans-serif;font-size:15px;text-align:center;vertical-align:top;color:#888">
															<small style="font-size:86%;font-weight:normal">
																<strong><?php esc_html_e( 'Notice', 'pff-flutterwave' ); ?></strong><br>
																<?php
																printf(
																	/* translators: %s: Payment amount */
																	esc_html__( "You're getting this email because you've made a payment of %s to ", 'pff-flutterwave' ),
																	esc_html( $this->currency . ' ' . number_format_i18n( $this->amount ) )
																);
																?>
																<a href="<?php echo esc_url( get_bloginfo( 'url' ) ); ?>" style="display:inline-block;text-decoration:none;font-family:Helvetica,Arial,sans-serif;color:#472A7A;font-weight:bold">
