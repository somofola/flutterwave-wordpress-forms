...
class Submissions {
	...
	public function __construct() {
		...
		add_action( 'admin_post_pff_flutterwave_export_excel', [ $this, 'export_excel' ] );
	}
	...
	public function register_submissions_page() {
		add_submenu_page( 'edit.php?post_type=flutterwave_form', esc_html__( 'Submissions', 'pff-flutterwave' ), esc_html__( 'Submissions', 'pff-flutterwave' ), 'administrator', 'submissions', [ $this, 'output_submissions_page' ] );
		remove_submenu_page( 'edit.php?post_type=flutterwave_form', 'submissions' );
	}
	...
	public function output_submissions_page() {
		...
		if ( 'flutterwave_form' === get_post_type( $form ) ) {
			...
			<div class="info-panel">
				...
				<h1 style="margin: 0px;"><?php echo esc_html( get_the_title( $form ) ); ?> <?php esc_html_e( 'Payments', 'pff-flutterwave' ); ?></h1>
	 ...
	 *
	 * @return \flutterwave\payment_forms\Payments_List_Table
	 */
	public function get_payments_list_table() {
		if ( ! class_exists( 'WP_List_Table' ) ) {
			include_once ABSPATH . 'wp-admin/includes/class-wp-list-table.php';
		}
		include_once PFF_FLUTTERWAVE_PLUGIN_PATH . 'includes/classes/class-payments-list-table.php';
		return new \flutterwave\payment_forms\Payments_List_Table();
	}
