=== Payment Forms for Flutterwave ===
Contributors: Shola Omofola
Author URI: https://github.com/somofola
Plugin URI: https://github.com/somofola/flutterwave-wordpress-forms
Tags: flutterwave, payment, forms, payments, donations
...
Accept payments via Flutterwave directly from WordPress forms. Create forms with multiple input fields and have your users pay before submission. Form submission results are available on your dashboard.
...
*  Create your plan on the [official flutterwave dashboard](https://dashboard.flutterwave.com)
...
If you have suggestions or a new feature request, open an issue at [GitHub](https://github.com/somofola/flutterwave-wordpress-forms/issues).
...
* Confirm that your server can conclude a TLSv1.2 connection to Flutterwave's servers. More information about this requirement can be gleaned here: [TLS v1.2 requirement](https://developers.flutterwave.co/blog/tls-v12-requirement).
* A Flutterwave account
 
= Automatic installation =
 
Automatic installation is the easiest option as WordPress handles the file transfers itself and you don’t need to leave your web browser. To do an automatic install of Payment Forms of Flutterwave, log in to your WordPress dashboard, navigate to the Plugins menu and click Add New.
 
In the search field type “Payment Forms for Flutterwave” and click Search Plugins. Once you’ve found our payment plugin you can view details about it such as the point release, rating and description. Most importantly of course, you can install it by simply clicking “Install Now”.
...
= Where can I find help and documentation to understand Flutterwave? =
 
You can find help and information on Flutterwave on our [Help Desk](https://flutterwave.com/help)
 
= Where can I get support or talk to other users? =

Open an issue at [GitHub](https://github.com/somofola/flutterwave-wordpress-forms/issues).

= Payment Forms for Flutterwave is awesome! Can I contribute? =

Yes. Fork and submit PRs on the [GitHub repository](https://github.com/somofola/flutterwave-wordpress-forms).

== Changelog ==

= 1.0.0 =
* Initial release as a community fork by Shola Omofola.
* Schema hardening: `amount` now `decimal(11,2)`; `ip` `varchar(45)` (IPv6); `modified` uses `CURRENT_TIMESTAMP ON UPDATE`; `deleted_at` and `paid_at` properly nullable.
* Added indexes on `post_id`, `user_id`, `transaction_id`.
* DB upgrade path (`pff_flutterwave_db_version` 1.0 → 1.1) migrates existing installs in place.
...
= 3.3.6 =
* Add the flutterwave plugin metrics tracker
= 3.3.5=
